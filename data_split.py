    ...
    if match:
        ...
        if not mark:
            ...
            if (
                ...
                and "简要分析" not in question
                and "简要介绍" not in question
                and "元" not in question
                and "职工薪酬" not in question
            ):
                count3 += 1
                ...
                "多少" in question
                or ("单位" in question and "元" in question)
                or "金额" in question
                or re.search(pattern3, question)
            ):
                count5 += 1
